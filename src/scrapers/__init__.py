...
Cada módulo (`nuroa`, `lamudi`, `mercadolibre`, `vivanuncios`, `doomos`) expone
...
lista que consume el orquestador (Task 7) para recorrer las cinco fuentes.
"""
from __future__ import annotations

from scrapers import doomos, lamudi, mercadolibre, nuroa, vivanuncios
